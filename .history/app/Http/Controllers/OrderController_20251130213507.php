...
class OrderController extends Controller
{
    ...
    public function index()
    {
        ...
        $totalDiproses = Orders::where('status_order', 'diproses');
        $totalReady = Orders::where('status_order', 'ready');
        $totalDiambil = Orders::where('status_order', 'diambil');
        return view('orders.main', compact('dataOrder', 'currentlyDate', 'totalOrder', 'totalMenunggu', 'totalDiproses', 'totalReady', ''));
    }
