    ...
    public function exportPDF(Request $request)
    {
        ...
        switch ($jenis) {
            ...
            case 'transaksi':
                ...
                $view = 'pdf.laporan_transaksi';
                break;


            case 'pendapatan':
                $data = Pembayaran::whereBetween('created_at', [$startDate, $endDate])
                        ->orderBy('id_pembayaran', 'DESC')
                        ->get();

                $view = 'pdf.laporan_pendapatan';
                break;
            ...
            case 'layanan':
                ...
                $view = 'pdf.laporan_layanan';
                break;


            case 'keuangan':
                $data = Pembayaran::whereBetween('created_at', [$startDate, $endDate])->get();

                $view = 'pdf.laporan_keuangan';
                break;
