...
class OrderController extends Controller
{
    ...
    public function create()
    {
        ...
        $kodeOrder = 'OR-' . Carbon::now()->format('Ymd') . '-' . $orderNumberFormatted;
    ...
    public function store(Request $request)
    {
        try{
            ...
            Orders::create([
                'id_order' => $newId,
                'id_order' => $validated['nama_layanan'],
                'kode_order' => $validated['nama_layanan'],
                'id_pelanggan' => $validated['nama_layanan'],
                'id_layanan' => $validated['nama_layanan'],
                'berat' => $validated['nama_layanan'],
                'jumlah' => $validated['nama_layanan'],
                'total' => $validated['nama_layanan'],
                'status_order' => $validated['nama_layanan'],
                'catatan' => $validated['nama_layanan'],
                'tanggal_masuk' => $validated['nama_layanan'],
                'tanggal_selesai' => $validated['nama_layanan'],
            ]);
