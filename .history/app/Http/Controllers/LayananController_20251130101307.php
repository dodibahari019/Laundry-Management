...
class LayananController extends Controller
{
    ...
    public function store(Request $request)
    {
         try{
            ...
            if ($lastIdTransaksi) {
                $lastNumber = (int)substr($lastIdTransaksi->id_kamar, 3); // Ambil angka dari 'SUP001'
            ...
            Layanan::create([
                'id_layanan' => $newId,
                'nama_layanan' => $validated['nomorKamar'],
                'jenis' => $validated['ukuran'],
                'harga' => $validated['tipeKamar'],
                'durasi' => $validated['hargaSewa'],
                'status' => $validated['statusKamar'],
            ]);
