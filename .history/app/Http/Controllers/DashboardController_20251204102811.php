...
class DashboardController extends Controller
{
    ...
    public function getData()
    {
        ...
        // ========================================
        // 2. ORDER DALAM PROSES
        // ========================================
        $totalOrderProcess = Orders::whereIn('status_order', ['diproses', 'dicuci', 'disetrika'])->count();
        $prosesCount = Orders::where('status_order', 'diproses')->count();
        $cuciCount = Orders::where('status_order', 'dicuci')->count();
        $setrikaCount = Orders::where('status_order', 'disetrika')->count();
        ...
        // ========================================
        $totalRevenueToday = Pembayaran::whereDate('tanggal_bayar', $today)->sum('jumlah');
        $revenueYesterday = Pembayaran::whereDate('tanggal_bayar', $yesterday)->sum('jumlah');
