...
<form action="/pelanggan" method="POST" id="idCreateForm" class="classCreateForm p-6 space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
            ...
            <input name="no_hp" id="id_no_hp" type="text" placeholder="Contoh: 081564874762" class="classRp w-full pl-12 text-right px-6 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-500">
        </div>
        <div>
