...
<form method="POST" id="idCreateSubForm" class="classCreateSubForm p-6 space-y-6">
    ...
    <div>
        ...
        <textarea rows="3" na id="id_alamat" placeholder="Contoh: 89 Pine Avenue, Seattle, Washington, USA" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-500"></textarea>
    </div>
