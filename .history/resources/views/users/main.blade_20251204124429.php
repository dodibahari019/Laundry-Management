    ...
    <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden">
        <div class="p-6 border-b border-gray-200 flex items-center justify-between">
            <div>
                ...
                <p id="jumlahUsersInfo" class="text-sm text-gray-500 mt-1">Menampilkan {{ $jumlahSemua }} users, {{ $jumlahAdmin }} admin, {{ $jumlahKasir }} kasir, & {{ $jumlahPetugas }} petugas</p>
            </div>
    ...
    function fetchData(page = 1) {
        ...
        timer = setTimeout(() => {
            ...
            $.ajax({
                url: '/users/search',
                type: 'GET',
                data: { users: users, jenis: jenis, harga: harga, page: page },
