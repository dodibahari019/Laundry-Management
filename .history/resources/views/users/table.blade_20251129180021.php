<table class="w-full">
    ...
    <tbody class="divide-y divide-gray-100">
        ...
        <tr class="hover:bg-gray-50 transition">
            ...
            <td class="py-4 px-6">
                <p class="font-semibold text-gray-900">Andy</p>
            </td>

            <td class="py-4 px-6">
                <p class="text-gray-900">andy@mail.com</p>
            </td>
        ...
        <tr class="hover:bg-gray-50 transition">
            ...
            <td class="py-4 px-6">
                <p class="font-semibold text-gray-900">Budi</p>
            </td>

            <td class="py-4 px-6">
                <p class="text-gray-900">budi@mail.com</p>
            </td>
