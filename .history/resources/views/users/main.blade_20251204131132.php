    ...
    <div class="bg-white rounded-2xl p-6 mb-6 border border-gray-100">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div class="md:col-span-2">
                ...
                <div class="relative">
                    <input id="searchInput" type="text" placeholder="Cari username, nama, email..." class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-500">
            ...
            <div>
                ...
                <select id="filterRole" class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-500">
            ...
            <div class="flex items-end">
                <button data-url="/users/create" class="modal-crud w-full px-4 py-2.5 gradient-primary text-white rounded-xl font-semibold hover:shadow-lg transition flex items-center justify-center space-x-2">
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="py-4 px-6">
                        <div class="flex items-center justify-center space-x-2">
                            ...
                            <form id="deleteForm${x.id_user}" action="/layanan/${x.id_user}" method="POST" style="display:none;">
                                @csrf
                                @method('DELETE')
                            </form>
                            <button onclick="confirmDelete('${x.id_user}')"" class="text-red-600 hover:text-red-800 p-1" title="Hapus">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<script>
    ...
    }else if ((email == "" || berat == 0) && (qty == "" || qty == 0)) {
        return Swal.fire({
            icon: "warning",
            confirmButtonColor: "#6D28D9",
            title: "Peringatan",
