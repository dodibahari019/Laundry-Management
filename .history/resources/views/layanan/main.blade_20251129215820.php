        ...
        <div class="p-6 border-t border-gray-200 flex items-center justify-between">
            ...
            <div class="flex space-x-2">
                @if($dataLayanan->onFirstPage())
                    <button  class="px-3 py-2 border rounded text-gray-600">Previous</button>
                    <button disabled class="px-3 py-2 border border-gray-300 rounded-lg text-sm text-gray-600 hover:bg-gray-50 disabled:opacity-50" disabled>
                        Previous
                    </button>
                @else
