            ...
            <form class="p-6 space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <div class="flex space-x-3">
                            <input type="text" placeholder="0" class="classRp flex-1 px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-500">
