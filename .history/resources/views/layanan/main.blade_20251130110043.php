...
<script>
    function JustRunThisButton(){
        ...
        if(nama_layanan == '' || nama_layanan == null){
            Swal.fire({
    icon: "warning",               // icon: warning, error, info, success
    title: "Peringatan",           // judul popup
    text: "Harap Isi Nama Layanan!", // pesan spesifik untuk field
    confirmButtonColor: "#2600FF", // warna tombol OK
    width: '320px',                 // ukuran popup
