<table class="w-full">
    ...
    <tbody class="divide-y divide-gray-100">
        ...
        <tr class="hover:bg-gray-50 transition">
            ...
            <td class="py-4 px-6">
                @if($x->jenis == 'kiloan')
                    <span class="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-xs font-bold">{{ $x->jenis }}</span>
                @else
                    <span class="bg-green-100 text-green-700 px-3 py-1 rounded-full text-xs font-bold">{{ $x->jenis }}</span>
                @endif
            </td>
