...
function updateInfo(res) {
    ...
    for (let page = 1; page <= res.last_page; page++) {
        paginationHtml += `<a href="{{ $url }}" class="px-3 py-2 rounded-lg text-sm font-semibold {->currentPage() == $page ? 'bg-purple-600 text-white' : 'border text-gray-600 hover:bg-gray-50' }}">{{ $page }}</a>`;
    }
