        ...
        <div class="p-6 border-t border-gray-200 flex items-center justify-between">
            ...
            <div class="flex space-x-2">
                ...
                @foreach ($dataLayanan->getUrlRange(1, $dataLayanan->lastPage()) as $page => $url)
                    <a href="{{ $url }}" class="px-3 py-2 bg-purple-600 text-white rounded-lg text-sm font-semibold {{ $dataLayanan->currentPage() == $page ? 'bg-purple-600 text-white' : 'border text-gray-600 hover:bg-gray-50' }}">{{ $page }}</a>
                @endforeach
