                ...
                <div class="grid grid-cols-1 md:grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" placeholder="0" class="w-full pl-12 text-right pr-5 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-500">
                        </div>
                    </div>
                    <div>
