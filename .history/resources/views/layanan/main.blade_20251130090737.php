    ...
    if (res.data && res.data.length > 0) {
        res.data.forEach((x, index) => {
            ...
            <tr class="hover:bg-gray-50 transition">
                ...
                <td class="py-4 px-6">
                    <span class="${jenisColor} px-3 py-1 rounded-full text-xs font-bold">${x.jenis}</span>
                </td>
                <td class="py-4 px-6 text-right">
                    <p class="font-bold text-gray-900">Rp ${parseInt(x.harga).toLocaleString('id-ID')}</p>
                </td>
                <td class="py-4 px-6">
                    <div class="flex items-center space-x-2">
                        <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <td class="py-4 px-6">
                    <span class="${statusColor} px-3 py-1 rounded-full text-xs font-bold">${x.status}</span>
                </td>
                <td class="py-4 px-6">
                    <div class="flex items-center justify-center space-x-2">
                        <button onclick="openDetailModal()" class="text-blue-600 hover:text-blue-800 p-1" title="Detail">Detail</button>
                        <button onclick="openEditModal()" class="text-green-600 hover:text-green-800 p-1" title="Edit">Edit</button>
                        <button onclick="confirmDelete()" class="text-red-600 hover:text-red-800 p-1" title="Hapus">Hapus</button>
                    </div>
                </td>
            </tr>`;
        });
