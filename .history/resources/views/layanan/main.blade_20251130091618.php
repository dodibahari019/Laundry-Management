    ...
    <div class="bg-white rounded-2xl p-6 mb-6 border border-gray-100">
        <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div>
                ...
                <select filterHarga class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-500">
...
function fetchData() {
    ...
    timer = setTimeout(() => {
        ...
        $.ajax({
            url: '/layanan/search',
            type: 'GET',
            data: { q: query, jenis: jenis, harga: harga },
            success: function(res) {
                updateTable(res);
            },
            error: function(err) {
