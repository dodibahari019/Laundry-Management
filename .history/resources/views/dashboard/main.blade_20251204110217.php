    ...
    <div class="bg-white rounded-2xl p-6 border border-gray-100">
        ...
        <div class="grid grid-cols-2 gap-3 mt-4">
            ...
            <div class="text-center p-3 bg-yellow-50 rounded-lg">
                ...
                <p id="statusProcess" class="text-2xl font-bold text-yellow-600">0</p>
            </div>
            ...
            <div class="text-center p-3 bg-yellow-50 rounded-lg">
                ...
                <p id="statusDiambil" class="text-2xl font-bold text-yellow-600">0</p>
            </div>
            <div class="text-center p-3 bg-yellow-50 rounded-lg">
                <p class="text-xs text-gray-600 mb-1">Dibatalkan</p>
                <p id="statusCancel" class="text-2xl font-bold text-yellow-600">0</p>
            </div>
        </div>
    </div>
...
function updateCards(data) {
    ...
    $('#statusProcess').text(data.statusWashing || 0);
...
function updateCharts(data) {
    ...
    statusChart = new Chart(statusCtx, {
        type: 'doughnut',
        data: {
            labels: ['Menunggu', 'DiProses', 'Dicuci', 'Setrika', 'Siap', 'Diambil', 'Dibatalkan'],
            datasets: [{
                data: data.statusChartData || [0, 0, 0, 0],
                backgroundColor: ['#FBBF24', '#3B82F6', '#FB923C', '#A855F7', '#10B981', '#6B7280', '#EF4444']
            }]
        },
        options: {
            responsive: true,
