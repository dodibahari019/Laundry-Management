    ...
    <div class="bg-white rounded-2xl p-6 border border-gray-100">
        ...
        <div class="grid grid-cols-3 gap-3 mt-4">
            ...
            <div class="text-center p-2 bg-yellow-100 rounded-lg">
                ...
                <p id="statusProcess" class="text-2xl font-bold text-yellow-700">0</p>
            </div>
            <div class="text-center p-2 bg-blue-100 rounded-lg">
                <p class="text-xs text-gray-600 mb-1">Dicuci</p>
                <p id="statusWashing" class="text-2xl font-bold text-blue-700">0</p>
            </div>
            ...
            <div class="text-center p-2 bg-yellow-100 rounded-lg">
                ...
                <p id="statusDiambil" class="text-2xl font-bold text-yellow-700">0</p>
            </div>
            <div class="text-center p-2 bg-yellow-100 rounded-lg">
                <p class="text-xs text-gray-600 mb-1">Dibatalkan</p>
                <p id="statusCancel" class="text-2xl font-bold text-yellow-700">0</p>
            </div>
        </div>
    </div>
