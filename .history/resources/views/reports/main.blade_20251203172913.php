        ...
        data.forEach((x, i) => {
            ...
            if (jenis === "transaksi") {
                ...
                <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="py-4 px-6 text-right">
                            <p class="font-semu text-gray-900">${(Number(x.jumlah_transaksi)).toLocaleString('id-ID', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}</p>
                        </td>
                        <td class="py-4 px-6 text-right">
                            <p class="font-semu text-gray-900">Rp ${(Number(x.total_pendapatan)).toLocaleString('id-ID', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}</p>
                        </td>
                        <td class="py-4 px-6 text-right">
                            <p class="font-semu text-gray-900">Rp ${(Number(x.rata_rata_per_transaksi)).toLocaleString('id-ID', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}</p>
                        </td>
                        <td class="py-4 px-6">
                            <div>
                                <p class="font-semibold text-purple-600">#${x.kode_order}</p>
