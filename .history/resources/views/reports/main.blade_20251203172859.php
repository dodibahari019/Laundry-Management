...
<script>
    function getColspan(jenis) {
        ...
        if (jenis === "pendapatan") return 2;
        if (jenis === "pelanggan") return 3;
        return 1;
    }
        ...
        data.forEach((x, i) => {
            ...
            if (jenis === "transaksi") {
                ...
                <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="py-4 px-6 text-right">
                            <p class="font-bold text-gray-900">${(Number(x.jumlah_transaksi)).toLocaleString('id-ID', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}</p>
                        </td>
                        <td class="py-4 px-6 text-right">
                            <p class="font-bold text-gray-900">Rp ${(Number(x.total_pendapatan)).toLocaleString('id-ID', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}</p>
                        </td>
                        <td class="py-4 px-6 text-right">
                            <p class="font-bold text-gray-900">Rp ${(Number(x.rata_rata_per_transaksi)).toLocaleString('id-ID', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}</p>
                        </td>
                        <td class="py-4 px-6">
                            <div>
                                <p class="font-semibold text-purple-600">#${x.kode_order}</p>
    ...
    function TampilkanLaporan() {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                // 1. Render kolom thead sesuai jenis laporan
