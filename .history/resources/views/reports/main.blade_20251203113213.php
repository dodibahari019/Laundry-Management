...
@section('MainContentArea')
    ...
    <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden">
        ...
        <div class="p-6 border-t border-gray-200 flex items-center justify-between">
            ...
            <div id="paginationReportContainer" class="flex space-x-2">
...
<script>
    ...
    function fetchDataLaporan(page = 1) {
        ...
        timer = setTimeout(() => {
            ...
            $.ajax({
                url: '/orders/search',
                type: 'GET',
                data: { jenisLaporan: jenisLaporan, periodType: periodType, startDate: startDate, endDate: endDate, page: page
                 },
    ...
    // Event listener
    // $('#searchOrder, #filterStatus, #filterTanggal').on('keyup change', () => fetchDataLaporan());
    $('#searchOrder').on('keyup', () => fetchDataLaporan());
    $('#filterStatus, #filterTanggal').on('change', () => fetchDataLaporan());
</script>
<script>
