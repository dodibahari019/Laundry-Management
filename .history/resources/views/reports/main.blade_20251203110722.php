    ...
    <div class="bg-white rounded-2xl p-6 mb-6 border border-gray-100">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <select onchange="" id="reportType" class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-500">
    ...
    <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden">
        ...
        <div class="p-6 border-b border-gray-200 flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Periode: {{ \Carbon\Carbon::parse($currentlyDate)->format('d M Y') }} - {{ \Carbon\Carbon::parse($currentlyDate)->format('d M Y') }}</p>
            </div>
        </div>
    ...
    function updateTableReport(res) {
        ...
        if (res.data && res.data.length > 0) {
            res.data.forEach((x, index) => {
                let jenisLaporan = document.getElementById('').value;
                // Nomor urut
