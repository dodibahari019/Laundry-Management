    ...
    <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden">
        ...
        <div class="p-6 border-b border-gray-200 flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Periode: {{ \Carbon\Carbon::parse($x->tanggal_masuk)->format('d M Y H:i') }} - {{ \Carbon\Carbon::parse($x->tanggal_masuk)->format('d M Y H:i') }}</p>
            </div>
        </div>
