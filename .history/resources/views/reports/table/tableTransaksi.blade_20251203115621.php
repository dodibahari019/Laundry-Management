<div class=" w-full overflow-x-auto">
    <table class="min-w-max w-full border-collapse">
        ...
        <tbody id="idBodyTableLaporanTransaksi" class="divide-y divide-gray-100">
            @foreach($dataOrder as $index => $x)
            <tr class="hover:bg-gray-50 transition">
                <td class="py-4 px-6"><span class="font-semibold text-gray-900">{{ $dataLayanan->firstItem() + $loop->index }}</span></td>
                <td class="py-4 px-6">
                    <div>
