    ...
    <table class="w-full">
        <thead class="bg-gray-50">
            <tr>
                ...
                <th class="text-right py-4 px-6 text-xs font-semibold text-gray-600 uppercase">Jenis</th>
                <th class="text-left py-4 px-6 text-xs font-semibold text-gray-600 uppercase">Berat</th>
                <th class="text-center py-4 px-6 text-xs font-semibold text-gray-600 uppercase">Qty</th>
            </tr>
        </thead>
