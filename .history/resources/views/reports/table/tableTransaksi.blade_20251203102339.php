    ...
    <table class="min-w-max w-full border-collapse">
        <thead class="bg-gray-50">
            <tr>
                ...
                <th class="text-lecenterft py-4 px-6 text-xs font-semibold text-gray-600 uppercase">Petugas</th>
            </tr>
        </thead>
            ...
            <tr class="hover:bg-gray-50 transition">
                ...
                <td class="py-4 px-6">
                    <div class="flex items-center space-x-2">
                        ...
                        @endif
                        @php
                            $estimasi = $x->status_order == 'diambil'? 'Selesai' : \Carbon\Carbon::parse($x->tanggal_selesai)->format('d M Y H:i');
                        @endphp
                        <span class="text-sm text-gray-900">{{ $estimasi }}</span>
                    </div>
                </td>
