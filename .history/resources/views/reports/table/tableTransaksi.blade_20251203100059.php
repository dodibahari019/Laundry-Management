    ...
    <table class="w-full">
        <thead class="bg-gray-50">
            <tr>
                ...
                <th class="text-left py-4 px-6 text-xs font-semibold text-gray-600 uppercase">Berat</th>
                <th class="text-left py-4 px-6 text-xs font-semibold text-gray-600 uppercase">Qty</th>
                <th class="text-left py-4 px-6 text-xs font-semibold text-gray-600 uppercase">Total</th>
                ...
                <th class="text-left py-4 px-6 text-xs font-semibold text-gray-600 uppercase">Dibayar</th>
                <th class="text-left py-4 px-6 text-xs font-semibold text-gray-600 uppercase">Kembalian</th>
