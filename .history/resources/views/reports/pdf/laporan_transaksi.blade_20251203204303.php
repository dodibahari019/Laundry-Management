        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <span class="badge">{{ rtrim(rtrim(number_format($beratQty, 2, ',', '.'), '0'), ',') }} {{ $satuan }}</span>
                </td>
                <td class="text-right font-bold">Rp {{ number_format($item->total, 0, ',', '.') }}</td>
                <td class="text-center">
                    <span class="badge">{{ strtoupper($item->status_order) }}</span>
                </td>
                <td class="text-center">{{ \Carbon\Carbon::parse($item->tanggal_selesai)->format('d/m/Y') }}</td>
                <td class="text-center">
                    <span class="badge">{{ strtoupper($item->metode) }}</span>
                </td>
