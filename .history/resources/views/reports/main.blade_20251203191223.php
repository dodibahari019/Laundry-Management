    ...
    function TampilkanLaporan() {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if(res.allTransaksi) {
                    $("#cardTotalTransaksi").text(shortNumJavascript(res.allTransaksi[0].jumlah_transaksi));
                }
                if(res.allPendapatan) {
                    $("#cardTotalPendapatan").text("Rp " + shortNumJavascript(res.allPendapatan[0].total_pendapatan));
                }
                if(res.allPelanggan) {
                    $("#cardTotalPelanggan").text(shortNumJavascript(res.allPelanggan[0].jumlah_pelanggan));
                }
                if(res.allRataRata) {
                    $("#cardRataRata").text("Rp " + shortNumJavascript(res.allRataRata[0].rata_rata_per_transaksi));
                }
