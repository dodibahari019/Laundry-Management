...
@section('MainContentArea')
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
        ...
        <div class="bg-white rounded-2xl p-6 border border-gray-100 hover-scale">
            ...
            <h3 class="text-2xl font-bold text-gray-900">{{ $totalTransaksi }} {{number_format($l->harga,0,',' , '.')}}/{{$</h3>
        </div>
        ...
        <div class="bg-white rounded-2xl p-6 border border-gray-100 hover-scale">
            ...
            <h3 class="text-2xl font-bold text-gray-900">Rp {{ $totalPendapatan }}</h3>
        </div>
        ...
        <div class="bg-white rounded-2xl p-6 border border-gray-100 hover-scale">
            ...
            <h3 class="text-2xl font-bold text-gray-900">Rp {{ $rataRata }}</h3>
        </div>
    </div>
