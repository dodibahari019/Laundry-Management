...
<body class="bg-gray-50">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div id="contentWrapper" class="flex-1 flex flex-col overflow-hidden transition-all duration-300">
            ...
            {{-- <main id="mainContent" class="flex-1 overflow-x-hidden overflow-y-auto no-scrollbar bg-gray-50 p-8 transition-all duration-300"> --}}
                <main id="mainContent" class="pl-64 p-8 transition-all duration-300">
...
sidebarToggle.addEventListener('click', () => {
    ...
    // adjust content padding-left smoothly
    if (isCollapsed) {
