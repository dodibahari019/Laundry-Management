<aside id="sidebar" class="sidebar bg-gray-900 text-gray-300 w-64 flex-shrink-0 overflow-y-auto no-scrollbar">
            <div class="p-6">
                ...
                <nav class="space-y-2">
                    <!-- Dashboard -->
                    <a href="/dashboard" class="menu-item flex items-center space-x-3 px-4 py-3 rounded-lg">
                    ...
                    <!-- Order -->
                    <div class="space-y-1">
                        <a href="/orders" class="menu-item  @if(request()->is('layanan*')) active @endif" flex items-center space-x-3 px-4 py-3 rounded-lg">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Layanan -->
                    <a href="/layanan" class="menu-item flex items-center space-x-3 px-4 py-3 rounded-lg">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Customer -->
                    <a href="/pelanggan" class="menu-item flex items-center space-x-3 px-4 py-3 rounded-lg">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Laporan -->
                    <a href="/laporan" class="menu-item flex items-center space-x-3 px-4 py-3 rounded-lg">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
