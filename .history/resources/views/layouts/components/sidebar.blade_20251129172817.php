<aside id="sidebar" class="sidebar bg-gray-900 text-gray-300 w-64 flex-shrink-0 overflow-y-auto no-scrollbar">
            <div class="p-6">
                ...
                <nav class="space-y-2">
                    ...
                    <!-- Pembayaran -->
                    <a href="/status-laundry" class="menu-item @if(request()->is('status-laundry*')) active @endif flex items-center space-x-3 px-4 py-3 rounded-lg">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"></path>
                        </svg>
                        <span class="sidebar-text font-medium">Status Laundry</span>
                    </a>
                    ...
                    <a href="/users" class="menu-item flex items-center space-x-3 px-4 py-3 rounded-lg">
                        ...
                        <span class="sidebar-text font-medium">Setting User</span>
                    </a>
