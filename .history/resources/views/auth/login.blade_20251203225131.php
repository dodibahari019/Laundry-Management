...
<body class="bg-gray-50 min-h-screen py-20 flex items-center justify-center relative">
        ...
        <div class="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div class="text-center mb-10">
                    <div class="flex items-center justify-center space-x-3 mb-6">
                        <div class="w-16 h-16 gradient-primary rounded-2xl flex items-center justify-center shadow-2xl floating">
                            <img src="image/LogoDLaundry.png" alt="D`Laundry Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                        </div>
            ...
            <div class="fade-in">
                <div class="bg-white rounded-3xl shadow-2xl p-8 md:p-12 border border-gray-100">
                    ...
                    <form action="/login" method="POST" id="formLogin" class="space-y-6">
                        @csrf
    ...
    <script>
        function ButtonLoginNowPlease() {
            const username = document.getElementById('username').value.trim();
            const password = document.getElementById('password').value.trim();

            if (!username) {
                showAlert("Username belum diisi!");
            } else if (!password) {
                showAlert("Kata sandi belum diisi!");
            } else {
                // Tampilkan loading state
                const submitBtn = this.querySelector('button[type="submit"]');
                const originalText = submitBtn.innerHTML;
