...
<script>
    function ChooseSatuan(jenisSatuan){
        if(jenisSatuan == 'kilogram'){
            document.getElementById('id_berat').readonly = false;
            document.getElementById('id_berat').value = 0;
            document.getElementById('id_qty').readonly = true;
            document.getElementById('id_qty').value = 0;
        }else{
            document.getElementById('id_berat').readonly = true;
            document.getElementById('id_berat').value = 0;
            document.getElementById('id_qty').readonly = false;
            document.getElementById('id_qty').value = 0;
        }
    }
</script>
