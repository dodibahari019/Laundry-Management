...
<form action="/orders/{{ $orders->id_order }}" method="POST" id="idCreateFormOrders" class="classCreateForm p-6 space-y-6">
    @csrf
    ...
    <div class="bg-gradient-to-r from-purple-50 to-blue-50 p-4 rounded-xl border border-purple-200">
        <div class="flex items-center justify-between">
            <div>
                ...
                <input readonly name="kode_order" value="" id="id_kode_order" type="text" class="w-full px-2 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-500">
            </div>
