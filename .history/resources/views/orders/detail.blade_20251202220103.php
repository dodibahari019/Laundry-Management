   ...
   <div class="bg-white border border-gray-200 rounded-2xl p-6">
    ...
    <div class="bg-white border border-gray-200 rounded-2xl p-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <button onclick="onclickCancelOrders();" type="button" class="px-6 py-3 gradient-primary text-white rounded-xl font-semibold hover:shadow-lg transition flex items-center space-x-2">
