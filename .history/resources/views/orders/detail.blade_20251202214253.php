...
<div class="p-6 space-y-6 max-h-[70vh] overflow-y-auto no-scrollbar">
   ...
   <div class="bg-white border border-gray-200 rounded-2xl p-6">
    ...
    <div class="bg-white border border-gray-200 rounded-2xl p-6">
        ...
        <div class="space-y-4">
            <select id="filterStatusOrder" class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-500">
    ...
    <div class="py-6 border-t border-gray-200 flex items-center justify-between bg-white">
        <button type="button" onclick="closeDetailCrudModal()" class="px-6 py-3 border border-gray-300 rounded-xl text-gray-700 font-semibold hover:bg-gray-50 transition">
            ...
            <div class="flex space-x-3">
                <button onclick="onclickCancelOrders();" id="btnCancelOrder" type="button" class="px-6 py-3 gradient-primary text-white rounded-xl font-semibold hover:shadow-lg transition flex items-center space-x-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"></path>
                    </svg>
                    <span>Print</span>
                </button>
                <form id="changeStatus" action="/orders/{{ $order->id_order }}/cancel" method="POST">
                    @csrf
                    <input readonly type="text" value="{{ $order->status_order }}" id="id_change_status" name="status_order">
                </form>
            </div>
    </div>
</div>
