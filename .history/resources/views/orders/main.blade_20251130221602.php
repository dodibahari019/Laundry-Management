                ...
                html += `
                 <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="py-4 px-6 text-center">
                        <span class="${$jenisColor} px-3 py-1 rounded-full text-xs font-bold">Rp ${(Number(beratQty)).toLocaleString('id-ID', { minimumFractionDigits: 0, maximumFractionDigits: 0 })} ${satuan}</span>
                    </td>
