...
@section('MainContentArea')
    ...
    <div id="crudDataPelanggan" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
...
<script>
    function ButtonCreatePelangganBaru(){
        document.getElementById("crudDataPelanggan").classList.remove("hidden");
    }
</script>
@endsection
