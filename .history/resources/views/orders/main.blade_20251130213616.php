...
@section('MainContentArea')
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
        ...
        <div class="bg-white rounded-2xl p-5 border border-gray-100 hover-scale">
            ...
            <h3 class="text-xl font-bold text-gray-900">{{$totalOrder}}</h3>
        </div>
        ...
        <div class="bg-white rounded-2xl p-5 border border-gray-100 hover-scale">
            ...
            <h3 class="text-xl font-bold text-orange-600">{{$totalDiproses}}</h3>
        </div>
        ...
        <div class="bg-white rounded-2xl p-5 border border-gray-100 hover-scale">
            ...
            <h3 class="text-xl font-bold text-purple-600">{{$totalDiambil}}</h3>
        </div>
    </div>
