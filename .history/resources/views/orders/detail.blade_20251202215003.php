   ...
   <div class="bg-white border border-gray-200 rounded-2xl p-6">
    ...
    <div class="bg-white border border-gray-200 rounded-2xl p-6">
        ...
        <div class="flex items-center gap-4">
            <select id="filterStatusOrder" onchange="" class="w-full px-6 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-500">
