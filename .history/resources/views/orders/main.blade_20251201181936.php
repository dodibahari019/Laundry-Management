...
<script>
    ...
    function JustHitungTotal(inputValue){
        ...
        const formatRp = new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR' }).format(subtotal);
        ...
        let jumlah = jenis == 'kiloan'? 'Kg' : 'Pcs';
        let satuan = jenis == 'kiloan'? 'Kg' : 'Pcs';
        document.getElementById('idServicesThatYouChoose').innerText = selectedOption.getAttribute('data-layanan') + '(' + + satuan + ')';
    }
