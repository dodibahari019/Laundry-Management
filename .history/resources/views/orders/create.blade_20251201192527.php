        ...
        <div class="space-y-3">
            ...
            <div class="pt-3 border-t border-gray-300">
                <div class="flex items-center justify-between">
                    ...
                    <input disabled name="total" value="0" id="id_kode_order" type="text" class="w-full px-2 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-500">
                </div>
            </div>
        </div>
    </div>
