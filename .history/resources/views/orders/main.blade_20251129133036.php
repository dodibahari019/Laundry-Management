    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Kelola semua order laundry dengan mudah 🧺</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <button onclick="handleLogout()" class="flex items-center space-x-2 px-4 py-2 bg-red-50 text-red-600 rounded-xl hover:bg-red-100 transition font-medium">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50 p-8">
                ...
                <!-- Tab Navigation -->
                <div class="bg-white rounded-2xl p-2 mb-6 border border-gray-100 flex space-x-2">
                    <button onclick="switchTab('data-order')" class="tab-button active flex-1 px-6 py-3 rounded-xl font-semibold transition" data-tab="data-order">
                    ...
                    <button onclick="switchTab('tambah-order')" class="tab-button flex-1 px-6 py-3 rounded-xl font-semibold bg-gray-50 text-gray-600 hover:bg-gray-100" data-tab="tambah-order">
                        <div class="flex items-center justify-center space-x-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <button onclick="switchTab('update-status')" class="tab-button flex-1 px-6 py-3 rounded-xl font-semibold bg-gray-50 text-gray-600 hover:bg-gray-100" data-tab="update-status">
                        <div class="flex items-center justify-center space-x-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"></path>
                            </svg>
                ...
                <!-- Tab Content: Data Order -->
                <div id="data-order-content" class="tab-content fade-in">
                    ...
                    <div class="bg-white rounded-2xl p-6 mb-6 border border-gray-100">
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="relative">
                                    <input type="text" id="searchOrder" placeholder="Cari nama customer atau nomor invoice..." class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-500">
                            ...
                            <div>
                                ...
                                <select id="filterLayanan" class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-500">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                            ...
                            <div>
                                ...
                                <input type="date" id="filterTanggalMulai" class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-500">
                            </div>

                            <!-- Filter Tanggal Akhir -->
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Tanggal Akhir</label>
                                <input type="date" id="filterTanggalAkhir" class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-500">
                            </div>

                            <!-- Button Filter -->
                            <div class="flex items-end space-x-2">
                                <button onclick="applyFilter()" class="flex-1 gradient-primary text-white px-6 py-2.5 rounded-xl font-semibold hover:opacity-90 transition">
                                    Filter
                                </button>
                                <button onclick="resetFilter()" class="px-6 py-2.5 bg-gray-100 text-gray-600 rounded-xl font-semibold hover:bg-gray-200 transition">
                                    Reset
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                        ...
                        <div class="bg-white rounded-2xl p-6 hover-scale border border-gray-100">
                            ...
                            <h3 class="text-gray-500 text-sm font-medium">Dalam Proses</h3>
                    ...
                    <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden">
                        <div class="p-6 border-b border-gray-100">
                            <div class="flex items-center justify-between">
                                ...
                                <button onclick="switchTab('tambah-order')" class="gradient-primary text-white px-6 py-2.5 rounded-xl font-semibold hover:opacity-90 transition flex items-center space-x-2">
                                    <svg class="w-5 h-