...
<form action="/orders/{{ $orders->id_order }}" method="POST" id="idEditFormOrders" class="classEditForm p-6 space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-6">
        ...
        <div class="col-span-1">
            ...
            <input readonly name="qty" value="{{$orders}}" type="number" step="1" min="0" oninput="JustHitungTotal(this.value);" id="id_qty" placeholder="0" class="classRps w-full text-right pr-2 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-500">
        </div>
    </div>
