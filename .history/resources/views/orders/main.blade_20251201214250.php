...
@section('MainContentArea')
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
        ...
        <div class="bg-white rounded-2xl p-5 border border-gray-100 hover-scale">
            <div class="flex items-center justify-between mb-3">
                <div class="w-10 h-10 bg-grey-100 rounded-lg flex items-center justify-center">
                    <svg class="w-5 h-5 text-grey-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                    </svg>
                </div>
            </div>
            <p class="text-xs text-gray-500 mb-1">Diambil</p>
            <h3 class="text-xl font-bold text-grey-600">{{$totalDiambil}}</h3>
        </div>
    </div>
        ...
        if (res.data && res.data.length > 0) {
            res.data.forEach((x, index) => {
                ...
                if(statusLaundry == 'menunggu'){
                    ...
                    statusColor = 'bg-grey-100 text-grey-700';
                } else {
