    ...
    <div class="bg-white border border-gray-200 rounded-2xl p-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <form id="cancelFormOrders" action="/orders/{{ $order->id_order }}/cancel" method="POST">
                @csrf
                <input type="text" name="status_order" id="id_nama" placeholder="Contoh: Sabrina Anderson" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-500">
            </form>
