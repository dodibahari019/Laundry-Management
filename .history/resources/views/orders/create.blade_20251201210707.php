...
<form action="/orders" method="POST" id="idCreateFormOrders" class="classCreateForm p-6 space-y-6">
    ...
    <div>
        ...
        <div class="relative">
            <span class="absolute left-4 top-3 text-gray-500 font-medium">Rp</span>
            <input readonly name="totalBayar" id="id_kembalia" type="text" placeholder="0" class="classRp w-full pl-12 text-right pr-6 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-500">
        </div>
    </div>
