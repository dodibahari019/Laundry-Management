    ...
    {{-- TOTAL BAYAR USER --}}
     <div>
        ...
        <div class="relative">
            ...
            <input name="tota" id="id_harga" type="text" placeholder="0" class="classRp w-full pl-12 text-right pr-6 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-500">
        </div>
    </div>
