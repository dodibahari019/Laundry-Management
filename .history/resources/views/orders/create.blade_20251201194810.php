...
<form action="/orders" method="POST" id="idCreateFormOrders" class="classCreateForm p-6 space-y-6">
    ...
    <div class="bg-gradient-to-r from-purple-50 to-blue-50 p-4 rounded-xl border border-purple-200">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-2xl font-bold gradient-text">{{$kodeOrder}}</p>
                <input hidden disabled name="kode_order" value="{{$kodeOrder}}" id="id_kode_order" type="text" class="w-full px-2 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-500">
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-6">
        ...
        <div class="col-span-1">
            ...
            <input disabled name="berat" type="number" step="0.01" min="0" oninput="JustHitungTotal(this.value);" id="id_berat" placeholder="0" class="classRps w-full text-right pr-2 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-500">
        </div>
        <div class="col-span-1">
            <label class="block text-sm font-medium text-gray-700 mb-2">
                <span id="labelQty">Qty (pcs)</span> *
            </label>
            <input disabled name="qty" type="number" step="1" min="0" oninput="JustHitungTotal(this.value);" id="id_qty" placeholder="0" class="classRps w-full text-right pr-2 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-500">
        </div>
    </div>
        ...
        <div class="space-y-3">
            ...
            <div class="pt-3 border-t border-gray-300">
                <div class="flex items-center justify-between">
                    ...
                    <input hidden disabled name="total" value="0" id="id_total" type="text" class="classRp w-full px-2 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-500">
                </div>
            </div>
        </div>
    </div>
    ...
    {{-- TOTAL BAYAR USER --}}
     <div>
        ...
        <div class="relative">
            ...
            <input name="totalBayar" id="id_totalBayar" type="text" placeholder="0" class="classRp w-full pl-12 text-right pr-6 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-500">
        </div>
    </div>
