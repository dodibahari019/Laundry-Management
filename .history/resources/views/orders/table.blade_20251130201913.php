<table class="w-full">
    ...
    <tbody class="divide-y divide-gray-100">
        <!-- Row 1 -->
        @foreach($dataOrder as $key => $x)
        <tr class="hover:bg-gray-50 transition">
            <td class="py-4 px-6">
                <span class="font-semibold text-gray-900">{{ $dataOrder->firstItem() + $loop->index }}</span>
            </td>
            <td class="py-4 px-6">
                <div>
                    <p class="font-semibold text-purple-600">#{{ $x->kode_order }}</p>
                    <p class="text-xs text-gray-500">{{ $tanggal_masuk }}</p>
                </div>
            </td>
            <td class="py-4 px-6">
                <div>
                    <p class="font-semibold text-gray-900">{{ $nama }}</p>
                    <p class="text-xs text-gray-500">{{ $no_hp }}</p>
                </div>
            </td>
            <td class="py-4 px-6">
                <div>
            ...
            <td class="py-4 px-6 text-center">
                <span class="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-xs font-bold">{{ $x->berat }} kg / {{ $x->jumlah }} pcs</span>
            </td>
            ...
            <td class="py-4 px-6">
                <div class="flex justify-center">
                    <span class="bg-green-100 text-green-700 px-3 py-1 rounded-full text-xs font-bold">{{ $x->status_order }}</span>
                </div>
            </td>
            <td class="py-4 px-6">
                <div class="flex items-center space-x-2">
                    ...
                    <span class="text-sm text-gray-900">{{ $x->tanggal_selesai }}</span>
                </div>
            </td>
            <td class="py-4 px-6">
