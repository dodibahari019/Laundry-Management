    ...
    <div class="bg-white rounded-2xl p-6 mb-6 border border-gray-100">
        <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div class="md:col-span-2">
                ...
                <div class="relative">
                    <input id="" type="text" placeholder="Cari Kode order atau nama pelanggan..." class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-500">
