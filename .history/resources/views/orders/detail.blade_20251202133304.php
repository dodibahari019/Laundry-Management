    ...
    <div class="bg-gradient-to-r from-purple-50 to-blue-50 p-6 rounded-2xl border border-purple-200">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="text-right">
                <p class="text-sm text-gray-600 mb-1">Status Order</p>
                @php
                    ...
                    if($order->status_order == 'menunggu') {
                        ...
                        $statusIcon = 'M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z';
                        ...
                        $statusIcon = 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2';
                    } else {
            ...
            <div class="bg-white p-4 rounded-xl">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="font-bold text-gray-900">{{ \Carbon\Carbon::parse($order->tanggal_masuk)->format('d M Y, H:i') }}</p>
                    </div>
                </div>
            </div>
            <div class="bg-white p-4 rounded-xl">
            ...
            <div class="grid grid-cols-3 gap-4">
                <div class="text-center p-4 bg-gradient-to-br from-purple-50 to-blue-50 rounded-xl border border-purple-100">
                    ...
                    <p class="text-2xl font-bold gradient-text">
                        {{ $order->jenis == 'kiloan' ? number_format($order->berat, 2, ',', '.') : $order->qty }}
                    </p>
                ...
                <div class="text-center p-4 bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl border border-green-100">
                    <p class="text-xs text-gray-600 mb-2">Harga Satuan</p>
...
<!-- Action Buttons -->
<div class="p-6 border-t border-gray-200 flex items-center justify-between sticky bottom-0 bg-white">
    ...
    <div class="flex space-x-3">
        <button type="button" onclick="printOrder('{{ $order->kode_order }}')" class="px-6 py-3 bg-blue-600 text-white rounded-xl font-semibold hover:bg-blue-700 transition flex items-center space-x-2">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"></path>
            </svg>
            <span>Print</span>
        </button>
        <button type="button" data-url="/orders/{{ $order->id_order }}/edit" class="modal-crud px-6 py-3 gradient-primary text-white rounded-xl font-semibold hover:shadow-lg transition flex items-center space-x-2">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
