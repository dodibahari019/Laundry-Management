                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Kelola semua order laundry Anda 🧺</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <!-- New Order Button -->
                        <button id="btnNewOrder" class="gradient-primary text-white px-6 py-2.5 rounded-xl font-semibold hover:opacity-90 transition shadow-lg flex items-center space-x-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50 p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    ...
                    <div class="bg-white rounded-2xl p-6 hover-scale border border-gray-100">
                        ...
                        <h3 class="text-gray-500 text-sm font-medium mb-1">Siap Diambil</h3>
                        <p class="text-3xl font-bold text-gray-900">8</p>
                        <p class="text-xs text-gray-400 mt-2">Menunggu customer</p>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl p-6 hover-scale border border-gray-100">
                        ...
                        <p class="text-xs text-gray-400 mt-2">Melewati estimasi</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl p-6 mb-6 border border-gray-100">
                    <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                        ...
                        <div class="md:col-span-2">
                            <label class="text-sm font-medium text-gray-700 mb-2 block">Cari Order</label>
                            <div class="relative">
                                <input type="text" id="searchInput" placeholder="Cari nomor invoice, nama customer..." class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-500">
                        ...
                        <!-- Service Filter -->
                        <div>
                            <label class="text-sm font-medium text-gray-700 mb-2 block">Layanan</label>
                            <select id="filterService" class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-500">
                        ...
                        <div>
                            ...
                            <input type="date" id="filterDate" class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-100 focus:border-purple-500">
                        </div>
                    </div>

                    <div class="flex items-center justify-between mt-4 pt-4 border-t border-gray-100">
                        <p class="text-sm text-gray-500">Menampilkan <span class="font-semibold">25</span> dari <span class="font-semibold">842</span> order</p>
                        <button class="text-purple-600 text-sm font-semibold hover:underline">Reset Filter</button>
                    </div>
                </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            <thead class="bg-gray-50 border-b border-gray-200">
                                <tr>
                                    <th class="text-left py-4 px-6 text-sm font-semibold text-gray-600">No. Invoice</th>
                                    <th class="text-left py-4 px-6 text-sm font-semibold text-gray-600">Customer</th>
                                    <th class="text-left py-4 px-6 text-sm font-semibold text-gray-600">Layanan</th>
                                    <th class="text-left py-4 px-6 text-sm font-semibold text-gray-600">Berat/Item</th>
