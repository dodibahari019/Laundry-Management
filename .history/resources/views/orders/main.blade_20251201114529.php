    ...
    <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden">
        <div class="p-6 border-b border-gray-200 flex items-center justify-between">
            <div>
                ...
                <p id="jumlahLayananInfo" class="text-sm text-gray-500 mt-1">Menampilkan {{ $totalOrder }} order aktif</p>
            </div>
                 ...
                 <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="py-4 px-6">
                        <div>
                            ...
                            <p class="text-xs text-gray-500">${formatTanggalWaktu(x.tanggal_selesai)}</p>
                        </div>
                    </td>
                    <td class="py-4 px-6">
                        <div>
