<table class="w-full">
    ...
    <
            ...
            <td class="py-4 px-6">
                <div>
                    <p class="font-semibold text-purple-600">#OR-001242</p>
                    <p class="text-xs text-gray-500">27 Nov 2025, 09:30</p>
                </div>
            </td>
            <td class="py-4 px-6">
                <div>
            ...
            <td class="py-4 px-6 text-center">
                <span class="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-xs font-bold">6 kg</span>
            </td>
            <td class="py-4 px-6 text-right">
