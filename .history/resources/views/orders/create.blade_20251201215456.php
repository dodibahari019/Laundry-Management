...
<form action="/orders" method="POST" id="idCreateFormOrders" class="classCreateForm p-6 space-y-6">
    ...
    <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
        ...
        <button type="button" onclick="BustThisButton()" class="px-8 py-3 gradient-primary text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transition flex items-center space-x-2">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
